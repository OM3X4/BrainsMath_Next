    ...
    <>
        <nav className=' flex items-center justify-between px-32 flex-row h-20'>
            <div className=' flex items-center justify-between w-11/12'>
                <Link href={"/"}><h1 className='text-4xl font-bold text-navy cursor-pointer'>BrainsMath</h1></Link>
                <div className='flex items-center justify-center gap-5'>
                    <h5 className='cursor-pointer' onClick={e => {handleStart();}}>Get Started</h5>
                    <Link href={"/analyze"}><h5 className='cursor-pointer'>Practice & Statics</h5></Link>
                </div>
            </div>
