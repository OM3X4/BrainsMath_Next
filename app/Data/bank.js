const bank =
    [
        [
            { question: "100 + 200", choices: [300, 302, 297, 305].sort(() => Math.random() - 0.5), answer: 300, type: 0 }, { question: "113 + 217", choices: [330, 332, 327, 335].sort(() => Math.random() - 0.5), answer: 330, type: 0 }, { question: "126 + 234", choices: [360, 362, 357, 365].sort(() => Math.random() - 0.5), answer: 360, type: 0 }, { question: "139 + 251", choices: [390, 392, 387, 395].sort(() => Math.random() - 0.5), answer: 390, type: 0 }, { question: "152 + 268", choices: [420, 422, 417, 425].sort(() => Math.random() - 0.5), answer: 420, type: 0 }, { question: "165 + 285", choices: [450, 452, 447, 455].sort(() => Math.random() - 0.5), answer: 450, type: 0 }, { question: "178 + 302", choices: [480, 482, 477, 485].sort(() => Math.random() - 0.5), answer: 480, type: 0 }, { question: "191 + 319", choices: [510, 512, 507, 515].sort(() => Math.random() - 0.5), answer: 510, type: 0 }, { question: "204 + 336", choices: [540, 542, 537, 545].sort(() => Math.random() - 0.5), answer: 540, type: 0 }, { question: "217 + 353", choices: [570, 572, 567, 575].sort(() => Math.random() - 0.5), answer: 570, type: 0 }, { question: "230 + 370", choices: [600, 602, 597, 605].sort(() => Math.random() - 0.5), answer: 600, type: 0 }, { question: "243 + 387", choices: [630, 632, 627, 635].sort(() => Math.random() - 0.5), answer: 630, type: 0 }, { question: "256 + 404", choices: [660, 662, 657, 665].sort(() => Math.random() - 0.5), answer: 660, type: 0 }, { question: "269 + 421", choices: [690, 692, 687, 695].sort(() => Math.random() - 0.5), answer: 690, type: 0 }, { question: "282 + 438", choices: [720, 722, 717, 725].sort(() => Math.random() - 0.5), answer: 720, type: 0 }, { question: "295 + 455", choices: [750, 752, 747, 755].sort(() => Math.random() - 0.5), answer: 750, type: 0 }, { question: "308 + 472", choices: [780, 782, 777, 785].sort(() => Math.random() - 0.5), answer: 780, type: 0 }, { question: "321 + 489", choices: [810, 812, 807, 815].sort(() => Math.random() - 0.5), answer: 810, type: 0 }, { question: "334 + 506", choices: [840, 842, 837, 845].sort(() => Math.random() - 0.5), answer: 840, type: 0 }, { question: "347 + 523", choices: [870, 872, 867, 875].sort(() => Math.random() - 0.5), answer: 870, type: 0 }, { question: "360 + 540", choices: [900, 902, 897, 905].sort(() => Math.random() - 0.5), answer: 900, type: 0 }, { question: "373 + 557", choices: [930, 932, 927, 935].sort(() => Math.random() - 0.5), answer: 930, type: 0 }, { question: "386 + 574", choices: [960, 962, 957, 965].sort(() => Math.random() - 0.5), answer: 960, type: 0 }, { question: "399 + 591", choices: [990, 992, 987, 995].sort(() => Math.random() - 0.5), answer: 990, type: 0 }, { question: "412 + 608", choices: [1020, 1022, 1017, 1025].sort(() => Math.random() - 0.5), answer: 1020, type: 0 }, { question: "425 + 625", choices: [1050, 1052, 1047, 1055].sort(() => Math.random() - 0.5), answer: 1050, type: 0 }, { question: "438 + 642", choices: [1080, 1082, 1077, 1085].sort(() => Math.random() - 0.5), answer: 1080, type: 0 }, { question: "451 + 659", choices: [1110, 1112, 1107, 1115].sort(() => Math.random() - 0.5), answer: 1110, type: 0 }, { question: "464 + 676", choices: [1140, 1142, 1137, 1145].sort(() => Math.random() - 0.5), answer: 1140, type: 0 }, { question: "477 + 693", choices: [1170, 1172, 1167, 1175].sort(() => Math.random() - 0.5), answer: 1170, type: 0 }, { question: "490 + 710", choices: [1200, 1202, 1197, 1205].sort(() => Math.random() - 0.5), answer: 1200, type: 0 }, { question: "503 + 727", choices: [1230, 1232, 1227, 1235].sort(() => Math.random() - 0.5), answer: 1230, type: 0 }, { question: "516 + 744", choices: [1260, 1262, 1257, 1265].sort(() => Math.random() - 0.5), answer: 1260, type: 0 }, { question: "529 + 761", choices: [1290, 1292, 1287, 1295].sort(() => Math.random() - 0.5), answer: 1290, type: 0 }, { question: "542 + 778", choices: [1320, 1322, 1317, 1325].sort(() => Math.random() - 0.5), answer: 1320, type: 0 }, { question: "555 + 795", choices: [1350, 1352, 1347, 1355].sort(() => Math.random() - 0.5), answer: 1350, type: 0 }, { question: "568 + 812", choices: [1380, 1382, 1377, 1385].sort(() => Math.random() - 0.5), answer: 1380, type: 0 }, { question: "581 + 829", choices: [1410, 1412, 1407, 1415].sort(() => Math.random() - 0.5), answer: 1410, type: 0 }, { question: "594 + 846", choices: [1440, 1442, 1437, 1445].sort(() => Math.random() - 0.5), answer: 1440, type: 0 }, { question: "607 + 863", choices: [1470, 1472, 1467, 1475].sort(() => Math.random() - 0.5), answer: 1470, type: 0 }, { question: "620 + 880", choices: [1500, 1502, 1497, 1505].sort(() => Math.random() - 0.5), answer: 1500, type: 0 }, { question: "633 + 897", choices: [1530, 1532, 1527, 1535].sort(() => Math.random() - 0.5), answer: 1530, type: 0 }, { question: "646 + 914", choices: [1560, 1562, 1557, 1565].sort(() => Math.random() - 0.5), answer: 1560, type: 0 }, { question: "659 + 931", choices: [1590, 1592, 1587, 1595].sort(() => Math.random() - 0.5), answer: 1590, type: 0 }, { question: "672 + 948", choices: [1620, 1622, 1617, 1625].sort(() => Math.random() - 0.5), answer: 1620, type: 0 }, { question: "685 + 965", choices: [1650, 1652, 1647, 1655].sort(() => Math.random() - 0.5), answer: 1650, type: 0 }, { question: "698 + 982", choices: [1680, 1682, 1677, 1685].sort(() => Math.random() - 0.5), answer: 1680, type: 0 }, { question: "711 + 999", choices: [1710, 1712, 1707, 1715].sort(() => Math.random() - 0.5), answer: 1710, type: 0 }, { question: "724 + 1016", choices: [1740, 1742, 1737, 1745].sort(() => Math.random() - 0.5), answer: 1740, type: 0 }, { question: "737 + 1033", choices: [1770, 1772, 1767, 1775].sort(() => Math.random() - 0.5), answer: 1770, type: 0 }, { question: "750 + 1050", choices: [1800, 1802, 1797, 1805].sort(() => Math.random() - 0.5), answer: 1800, type: 0 }, { question: "763 + 1067", choices: [1830, 1832, 1827, 1835].sort(() => Math.random() - 0.5), answer: 1830, type: 0 }, { question: "776 + 1084", choices: [1860, 1862, 1857, 1865].sort(() => Math.random() - 0.5), answer: 1860, type: 0 }, { question: "789 + 1101", choices: [1890, 1892, 1887, 1895].sort(() => Math.random() - 0.5), answer: 1890, type: 0 }, { question: "802 + 1118", choices: [1920, 1922, 1917, 1925].sort(() => Math.random() - 0.5), answer: 1920, type: 0 }, { question: "815 + 1135", choices: [1950, 1952, 1947, 1955].sort(() => Math.random() - 0.5), answer: 1950, type: 0 }, { question: "828 + 1152", choices: [1980, 1982, 1977, 1985].sort(() => Math.random() - 0.5), answer: 1980, type: 0 }, { question: "841 + 1169", choices: [2010, 2012, 2007, 2015].sort(() => Math.random() - 0.5), answer: 2010, type: 0 }, { question: "854 + 1186", choices: [2040, 2042, 2037, 2045].sort(() => Math.random() - 0.5), answer: 2040, type: 0 }, { question: "867 + 1203", choices: [2070, 2072, 2067, 2075].sort(() => Math.random() - 0.5), answer: 2070, type: 0 }, { question: "880 + 1220", choices: [2100, 2102, 2097, 2105].sort(() => Math.random() - 0.5), answer: 2100, type: 0 }, { question: "893 + 1237", choices: [2130, 2132, 2127, 2135].sort(() => Math.random() - 0.5), answer: 2130, type: 0 }, { question: "906 + 1254", choices: [2160, 2162, 2157, 2165].sort(() => Math.random() - 0.5), answer: 2160, type: 0 }, { question: "919 + 1271", choices: [2190, 2192, 2187, 2195].sort(() => Math.random() - 0.5), answer: 2190, type: 0 }, { question: "932 + 1288", choices: [2220, 2222, 2217, 2225].sort(() => Math.random() - 0.5), answer: 2220, type: 0 }, { question: "945 + 1305", choices: [2250, 2252, 2247, 2255].sort(() => Math.random() - 0.5), answer: 2250, type: 0 }, { question: "958 + 1322", choices: [2280, 2282, 2277, 2285].sort(() => Math.random() - 0.5), answer: 2280, type: 0 }, { question: "971 + 1339", choices: [2310, 2312, 2307, 2315].sort(() => Math.random() - 0.5), answer: 2310, type: 0 }, { question: "984 + 1356", choices: [2340, 2342, 2337, 2345].sort(() => Math.random() - 0.5), answer: 2340, type: 0 }, { question: "997 + 1373", choices: [2370, 2372, 2367, 2375].sort(() => Math.random() - 0.5), answer: 2370, type: 0 }, { question: "1010 + 1390", choices: [2400, 2402, 2397, 2405].sort(() => Math.random() - 0.5), answer: 2400, type: 0 }, { question: "1023 + 1407", choices: [2430, 2432, 2427, 2435].sort(() => Math.random() - 0.5), answer: 2430, type: 0 }, { question: "1036 + 1424", choices: [2460, 2462, 2457, 2465].sort(() => Math.random() - 0.5), answer: 2460, type: 0 }, { question: "1049 + 1441", choices: [2490, 2492, 2487, 2495].sort(() => Math.random() - 0.5), answer: 2490, type: 0 }, { question: "1062 + 1458", choices: [2520, 2522, 2517, 2525].sort(() => Math.random() - 0.5), answer: 2520, type: 0 }, { question: "1075 + 1475", choices: [2550, 2552, 2547, 2555].sort(() => Math.random() - 0.5), answer: 2550, type: 0 }, { question: "1088 + 1492", choices: [2580, 2582, 2577, 2585].sort(() => Math.random() - 0.5), answer: 2580, type: 0 }, { question: "1101 + 1509", choices: [2610, 2612, 2607, 2615].sort(() => Math.random() - 0.5), answer: 2610, type: 0 }, { question: "1114 + 1526", choices: [2640, 2642, 2637, 2645].sort(() => Math.random() - 0.5), answer: 2640, type: 0 }, { question: "1127 + 1543", choices: [2670, 2672, 2667, 2675].sort(() => Math.random() - 0.5), answer: 2670, type: 0 }, { question: "1140 + 1560", choices: [2700, 2702, 2697, 2705].sort(() => Math.random() - 0.5), answer: 2700, type: 0 }, { question: "1153 + 1577", choices: [2730, 2732, 2727, 2735].sort(() => Math.random() - 0.5), answer: 2730, type: 0 }, { question: "1166 + 1594", choices: [2760, 2762, 2757, 2765].sort(() => Math.random() - 0.5), answer: 2760, type: 0 }, { question: "1179 + 1611", choices: [2790, 2792, 2787, 2795].sort(() => Math.random() - 0.5), answer: 2790, type: 0 }, { question: "1192 + 1628", choices: [2820, 2822, 2817, 2825].sort(() => Math.random() - 0.5), answer: 2820, type: 0 }, { question: "1205 + 1645", choices: [2850, 2852, 2847, 2855].sort(() => Math.random() - 0.5), answer: 2850, type: 0 }, { question: "1218 + 1662", choices: [2880, 2882, 2877, 2885].sort(() => Math.random() - 0.5), answer: 2880, type: 0 }, { question: "1231 + 1679", choices: [2910, 2912, 2907, 2915].sort(() => Math.random() - 0.5), answer: 2910, type: 0 }, { question: "1244 + 1696", choices: [2940, 2942, 2937, 2945].sort(() => Math.random() - 0.5), answer: 2940, type: 0 }, { question: "1257 + 1713", choices: [2970, 2972, 2967, 2975].sort(() => Math.random() - 0.5), answer: 2970, type: 0 }, { question: "1270 + 1730", choices: [3000, 3002, 2997, 3005].sort(() => Math.random() - 0.5), answer: 3000, type: 0 }, { question: "1283 + 1747", choices: [3030, 3032, 3027, 3035].sort(() => Math.random() - 0.5), answer: 3030, type: 0 }, { question: "1296 + 1764", choices: [3060, 3062, 3057, 3065].sort(() => Math.random() - 0.5), answer: 3060, type: 0 }, { question: "1309 + 1781", choices: [3090, 3092, 3087, 3095].sort(() => Math.random() - 0.5), answer: 3090, type: 0 }, { question: "1322 + 1798", choices: [3120, 3122, 3117, 3125].sort(() => Math.random() - 0.5), answer: 3120, type: 0 }, { question: "1335 + 1815", choices: [3150, 3152, 3147, 3155].sort(() => Math.random() - 0.5), answer: 3150, type: 0 }, { question: "1348 + 1832", choices: [3180, 3182, 3177, 3185].sort(() => Math.random() - 0.5), answer: 3180, type: 0 }, { question: "1361 + 1849", choices: [3210, 3212, 3207, 3215].sort(() => Math.random() - 0.5), answer: 3210, type: 0 }, { question: "1374 + 1866", choices: [3240, 3242, 3237, 3245].sort(() => Math.random() - 0.5), answer: 3240, type: 0 }, { question: "1387 + 1883", choices: [3270, 3272, 3267, 3275].sort(() => Math.random() - 0.5), answer: 3270, type: 0 }, { question: "1400 + 1900", choices: [3300, 3302, 3297, 3305].sort(() => Math.random() - 0.5), answer: 3300, type: 0 }, { question: "1413 + 1917", choices: [3330, 3332, 3327, 3335].sort(() => Math.random() - 0.5), answer: 3330, type: 0 }, { question: "1426 + 1934", choices: [3360, 3362, 3357, 3365].sort(() => Math.random() - 0.5), answer: 3360, type: 0 }, { question: "1439 + 1951", choices: [3390, 3392, 3387, 3395].sort(() => Math.random() - 0.5), answer: 3390, type: 0 }, { question: "1452 + 1968", choices: [3420, 3422, 3417, 3425].sort(() => Math.random() - 0.5), answer: 3420, type: 0 }, { question: "1465 + 1985", choices: [3450, 3452, 3447, 3455].sort(() => Math.random() - 0.5), answer: 3450, type: 0 }, { question: "1478 + 2002", choices: [3480, 3482, 3477, 3485].sort(() => Math.random() - 0.5), answer: 3480, type: 0 }, { question: "1491 + 2019", choices: [3510, 3512, 3507, 3515].sort(() => Math.random() - 0.5), answer: 3510, type: 0 }, { question: "1504 + 2036", choices: [3540, 3542, 3537, 3545].sort(() => Math.random() - 0.5), answer: 3540, type: 0 }, { question: "1517 + 2053", choices: [3570, 3572, 3567, 3575].sort(() => Math.random() - 0.5), answer: 3570, type: 0 }, { question: "1530 + 2070", choices: [3600, 3602, 3597, 3605].sort(() => Math.random() - 0.5), answer: 3600, type: 0 }, { question: "1543 + 2087", choices: [3630, 3632, 3627, 3635].sort(() => Math.random() - 0.5), answer: 3630, type: 0 }, { question: "1556 + 2104", choices: [3660, 3662, 3657, 3665].sort(() => Math.random() - 0.5), answer: 3660, type: 0 }, { question: "1569 + 2121", choices: [3690, 3692, 3687, 3695].sort(() => Math.random() - 0.5), answer: 3690, type: 0 }, { question: "1582 + 2138", choices: [3720, 3722, 3717, 3725].sort(() => Math.random() - 0.5), answer: 3720, type: 0 }, { question: "1595 + 2155", choices: [3750, 3752, 3747, 3755].sort(() => Math.random() - 0.5), answer: 3750, type: 0 }, { question: "1608 + 2172", choices: [3780, 3782, 3777, 3785].sort(() => Math.random() - 0.5), answer: 3780, type: 0 }, { question: "1621 + 2189", choices: [3810, 3812, 3807, 3815].sort(() => Math.random() - 0.5), answer: 3810, type: 0 }, { question: "1634 + 2206", choices: [3840, 3842, 3837, 3845].sort(() => Math.random() - 0.5), answer: 3840, type: 0 }, { question: "1647 + 2223", choices: [3870, 3872, 3867, 3875].sort(() => Math.random() - 0.5), answer: 3870, type: 0 }, { question: "1660 + 2240", choices: [3900, 3902, 3897, 3905].sort(() => Math.random() - 0.5), answer: 3900, type: 0 }, { question: "1673 + 2257", choices: [3930, 3932, 3927, 3935].sort(() => Math.random() - 0.5), answer: 3930, type: 0 }, { question: "1686 + 2274", choices: [3960, 3962, 3957, 3965].sort(() => Math.random() - 0.5), answer: 3960, type: 0 }, { question: "1699 + 2291", choices: [3990, 3992, 3987, 3995].sort(() => Math.random() - 0.5), answer: 3990, type: 0 }, { question: "1712 + 2308", choices: [4020, 4022, 4017, 4025].sort(() => Math.random() - 0.5), answer: 4020, type: 0 }, { question: "1725 + 2325", choices: [4050, 4052, 4047, 4055].sort(() => Math.random() - 0.5), answer: 4050, type: 0 }, { question: "1738 + 2342", choices: [4080, 4082, 4077, 4085].sort(() => Math.random() - 0.5), answer: 4080, type: 0 }, { question: "1751 + 2359", choices: [4110, 4112, 4107, 4115].sort(() => Math.random() - 0.5), answer: 4110, type: 0 }, { question: "1764 + 2376", choices: [4140, 4142, 4137, 4145].sort(() => Math.random() - 0.5), answer: 4140, type: 0 }, { question: "1777 + 2393", choices: [4170, 4172, 4167, 4175].sort(() => Math.random() - 0.5), answer: 4170, type: 0 }, { question: "1790 + 2410", choices: [4200, 4202, 4197, 4205].sort(() => Math.random() - 0.5), answer: 4200, type: 0 }, { question: "1803 + 2427", choices: [4230, 4232, 4227, 4235].sort(() => Math.random() - 0.5), answer: 4230, type: 0 }, { question: "1816 + 2444", choices: [4260, 4262, 4257, 4265].sort(() => Math.random() - 0.5), answer: 4260, type: 0 }, { question: "1829 + 2461", choices: [4290, 4292, 4287, 4295].sort(() => Math.random() - 0.5), answer: 4290, type: 0 }, { question: "1842 + 2478", choices: [4320, 4322, 4317, 4325].sort(() => Math.random() - 0.5), answer: 4320, type: 0 }, { question: "1855 + 2495", choices: [4350, 4352, 4347, 4355].sort(() => Math.random() - 0.5), answer: 4350, type: 0 }, { question: "1868 + 2512", choices: [4380, 4382, 4377, 4385].sort(() => Math.random() - 0.5), answer: 4380, type: 0 }, { question: "1881 + 2529", choices: [4410, 4412, 4407, 4415].sort(() => Math.random() - 0.5), answer: 4410, type: 0 }, { question: "1894 + 2546", choices: [4440, 4442, 4437, 4445].sort(() => Math.random() - 0.5), answer: 4440, type: 0 }, { question: "1907 + 2563", choices: [4470, 4472, 4467, 4475].sort(() => Math.random() - 0.5), answer: 4470, type: 0 }, { question: "1920 + 2580", choices: [4500, 4502, 4497, 4505].sort(() => Math.random() - 0.5), answer: 4500, type: 0 }, { question: "1933 + 2597", choices: [4530, 4532, 4527, 4535].sort(() => Math.random() - 0.5), answer: 4530, type: 0 }, { question: "1946 + 2614", choices: [4560, 4562, 4557, 4565].sort(() => Math.random() - 0.5), answer: 4560, type: 0 }, { question: "1959 + 2631", choices: [4590, 4592, 4587, 4595].sort(() => Math.random() - 0.5), answer: 4590, type: 0 }, { question: "1972 + 2648", choices: [4620, 4622, 4617, 4625].sort(() => Math.random() - 0.5), answer: 4620, type: 0 }, { question: "1985 + 2665", choices: [4650, 4652, 4647, 4655].sort(() => Math.random() - 0.5), answer: 4650, type: 0 }, { question: "1998 + 2682", choices: [4680, 4682, 4677, 4685].sort(() => Math.random() - 0.5), answer: 4680, type: 0 }, { question: "2011 + 2699", choices: [4710, 4712, 4707, 4715].sort(() => Math.random() - 0.5), answer: 4710, type: 0 }, { question: "2024 + 2716", choices: [4740, 4742, 4737, 4745].sort(() => Math.random() - 0.5), answer: 4740, type: 0 }, { question: "2037 + 2733", choices: [4770, 4772, 4767, 4775].sort(() => Math.random() - 0.5), answer: 4770, type: 0 }, { question: "2050 + 2750", choices: [4800, 4802, 4797, 4805].sort(() => Math.random() - 0.5), answer: 4800, type: 0 }, { question: "2063 + 2767", choices: [4830, 4832, 4827, 4835].sort(() => Math.random() - 0.5), answer: 4830, type: 0 }, { question: "2076 + 2784", choices: [4860, 4862, 4857, 4865].sort(() => Math.random() - 0.5), answer: 4860, type: 0 }, { question: "2089 + 2801", choices: [4890, 4892, 4887, 4895].sort(() => Math.random() - 0.5), answer: 4890, type: 0 }, { question: "2102 + 2818", choices: [4920, 4922, 4917, 4925].sort(() => Math.random() - 0.5), answer: 4920, type: 0 }, { question: "2115 + 2835", choices: [4950, 4952, 4947, 4955].sort(() => Math.random() - 0.5), answer: 4950, type: 0 }, { question: "2128 + 2852", choices: [4980, 4982, 4977, 4985].sort(() => Math.random() - 0.5), answer: 4980, type: 0 }, { question: "2141 + 2869", choices: [5010, 5012, 5007, 5015].sort(() => Math.random() - 0.5), answer: 5010, type: 0 }, { question: "2154 + 2886", choices: [5040, 5042, 5037, 5045].sort(() => Math.random() - 0.5), answer: 5040, type: 0 }, { question: "2167 + 2903", choices: [5070, 5072, 5067, 5075].sort(() => Math.random() - 0.5), answer: 5070, type: 0 }, { question: "2180 + 2920", choices: [5100, 5102, 5097, 5105].sort(() => Math.random() - 0.5), answer: 5100, type: 0 }, { question: "2193 + 2937", choices: [5130, 5132, 5127, 5135].sort(() => Math.random() - 0.5), answer: 5130, type: 0 }, { question: "2206 + 2954", choices: [5160, 5162, 5157, 5165].sort(() => Math.random() - 0.5), answer: 5160, type: 0 }, { question: "2219 + 2971", choices: [5190, 5192, 5187, 5195].sort(() => Math.random() - 0.5), answer: 5190, type: 0 }, { question: "2232 + 2988", choices: [5220, 5222, 5217, 5225].sort(() => Math.random() - 0.5), answer: 5220, type: 0 }, { question: "2245 + 3005", choices: [5250, 5252, 5247, 5255].sort(() => Math.random() - 0.5), answer: 5250, type: 0 }, { question: "2258 + 3022", choices: [5280, 5282, 5277, 5285].sort(() => Math.random() - 0.5), answer: 5280, type: 0 }, { question: "2271 + 3039", choices: [5310, 5312, 5307, 5315].sort(() => Math.random() - 0.5), answer: 5310, type: 0 }, { question: "2284 + 3056", choices: [5340, 5342, 5337, 5345].sort(() => Math.random() - 0.5), answer: 5340, type: 0 }, { question: "2297 + 3073", choices: [5370, 5372, 5367, 5375].sort(() => Math.random() - 0.5), answer: 5370, type: 0 }, { question: "2310 + 3090", choices: [5400, 5402, 5397, 5405].sort(() => Math.random() - 0.5), answer: 5400, type: 0 }, { question: "2323 + 3107", choices: [5430, 5432, 5427, 5435].sort(() => Math.random() - 0.5), answer: 5430, type: 0 }, { question: "2336 + 3124", choices: [5460, 5462, 5457, 5465].sort(() => Math.random() - 0.5), answer: 5460, type: 0 }, { question: "2349 + 3141", choices: [5490, 5492, 5487, 5495].sort(() => Math.random() - 0.5), answer: 5490, type: 0 }, { question: "2362 + 3158", choices: [5520, 5522, 5517, 5525].sort(() => Math.random() - 0.5), answer: 5520, type: 0 }, { question: "2375 + 3175", choices: [5550, 5552, 5547, 5555].sort(() => Math.random() - 0.5), answer: 5550, type: 0 }, { question: "2388 + 3192", choices: [5580, 5582, 5577, 5585].sort(() => Math.random() - 0.5), answer: 5580, type: 0 }, { question: "2401 + 3209", choices: [5610, 5612, 5607, 5615].sort(() => Math.random() - 0.5), answer: 5610, type: 0 }, { question: "2414 + 3226", choices: [5640, 5642, 5637, 5645].sort(() => Math.random() - 0.5), answer: 5640, type: 0 }, { question: "2427 + 3243", choices: [5670, 5672, 5667, 5675].sort(() => Math.random() - 0.5), answer: 5670, type: 0 }, { question: "2440 + 3260", choices: [5700, 5702, 5697, 5705].sort(() => Math.random() - 0.5), answer: 5700, type: 0 }, { question: "2453 + 3277", choices: [5730, 5732, 5727, 5735].sort(() => Math.random() - 0.5), answer: 5730, type: 0 }, { question: "2466 + 3294", choices: [5760, 5762, 5757, 5765].sort(() => Math.random() - 0.5), answer: 5760, type: 0 }, { question: "2479 + 3311", choices: [5790, 5792, 5787, 5795].sort(() => Math.random() - 0.5), answer: 5790, type: 0 }, { question: "2492 + 3328", choices: [5820, 5822, 5817, 5825].sort(() => Math.random() - 0.5), answer: 5820, type: 0 }, { question: "2505 + 3345", choices: [5850, 5852, 5847, 5855].sort(() => Math.random() - 0.5), answer: 5850, type: 0 }, { question: "2518 + 3362", choices: [5880, 5882, 5877, 5885].sort(() => Math.random() - 0.5), answer: 5880, type: 0 }, { question: "2531 + 3379", choices: [5910, 5912, 5907, 5915].sort(() => Math.random() - 0.5), answer: 5910, type: 0 }, { question: "2544 + 3396", choices: [5940, 5942, 5937, 5945].sort(() => Math.random() - 0.5), answer: 5940, type: 0 }, { question: "2557 + 3413", choices: [5970, 5972, 5967, 5975].sort(() => Math.random() - 0.5), answer: 5970, type: 0 }, { question: "2570 + 3430", choices: [6000, 6002, 5997, 6005].sort(() => Math.random() - 0.5), answer: 6000, type: 0 }, { question: "2583 + 3447", choices: [6030, 6032, 6027, 6035].sort(() => Math.random() - 0.5), answer: 6030, type: 0 }, { question: "2596 + 3464", choices: [6060, 6062, 6057, 6065].sort(() => Math.random() - 0.5), answer: 6060, type: 0 }, { question: "2609 + 3481", choices: [6090, 6092, 6087, 6095].sort(() => Math.random() - 0.5), answer: 6090, type: 0 }, { question: "2622 + 3498", choices: [6120, 6122, 6117, 6125].sort(() => Math.random() - 0.5), answer: 6120, type: 0 }, { question: "2635 + 3515", choices: [6150, 6152, 6147, 6155].sort(() => Math.random() - 0.5), answer: 6150, type: 0 }, { question: "2648 + 3532", choices: [6180, 6182, 6177, 6185].sort(() => Math.random() - 0.5), answer: 6180, type: 0 }, { question: "2661 + 3549", choices: [6210, 6212, 6207, 6215].sort(() => Math.random() - 0.5), answer: 6210, type: 0 }, { question: "2674 + 3566", choices: [6240, 6242, 6237, 6245].sort(() => Math.random() - 0.5), answer: 6240, type: 0 }, { question: "2687 + 3583", choices: [6270, 6272, 6267, 6275].sort(() => Math.random() - 0.5), answer: 6270, type: 0 },
